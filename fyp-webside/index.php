            ...
            <div class="row">
              ...
              <div class="col-lg-4 col-md-6 equel-grid">
                <div class="grid table-responsive">
                  <table class="table table-stretched index-grid">
                    <thead>
                      <tr>
                        <th>Symbol</th>
                        <th>Price</th>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="font-weight-medium"><?php getDataBySymbolN('AAPL')?></td>
                        <td class="text-danger font-weight-medium">
                          <?php getDataBySymbolC('AAPL')?>
                        </td>
                      </tr>
                       <tr>
                        <td>
                      ...
                      <tr>
                        <td>
                          <p class="mb-n1 font-weight-medium">MMM</p>
                          <small class="text-gray">Nike,Inc.</small>
                        </td>
                        <td class="font-weight-medium"><?php getDataBySymbolN('MMM')?></td>
                        <td class="text-danger font-weight-medium">
                          <?php getDataBySymbolC('MMM')?>
                        </td>
                      </tr>
                      <tr>
                        <td>
                          <p class="mb-n1 font-weight-medium">INTC</p>
                          <small class="text-gray">Nifty 50</small>
                        </td>
                        <td class="font-weight-medium"><?php getDataBySymbolN('INTC')?></td>
                        <td class="text-danger font-weight-medium">
                         <?php getDataBySymbolC('INTC')?>
                        </td>
                      </tr>
                      <tr>
                        <td>
                          <p class="mb-n1 font-weight-medium">JPM</p>
                          <small class="text-gray">The Boeing Company</small>
                        </td>
                        <td class="font-weight-medium"><?php getDataBySymbolN('JPM')?></td>
                        <td class="text-success font-weight-medium">
                          <?php getDataBySymbolC('JPM')?>
                        </td>
                      </tr>
                      <tr>
                        <td>
                          <p class="mb-n1 font-weight-medium">DE</p>
                          <small class="text-gray">Starbucks Corporation</small>
                        </td>
                        <td class="font-weight-medium"><?php getDataBySymbolN('DE')?></td>
                        <td class="text-success font-weight-medium">
                          <?php getDataBySymbolC('DE')?>
                        </td>
                      </tr>
                      <tr>
                        <td>
                          <p class="mb-n1 font-weight-medium">WFC</p>
                          <small class="text-gray">Starbucks Corporation</small>
                        </td>
                        <td class="font-weight-medium"><?php getDataBySymbolN('WFC')?></td>
                        <td class="text-success font-weight-medium">
                          <?php getDataBySymbolC('WFC')?>
                        </td>
                      </tr>
                      <tr>
                        <td>
                          <p class="mb-n1 font-weight-medium">BK</p>
                          <small class="text-gray">Starbucks Corporation</small>
                        </td>
                        <td class="font-weight-medium"><?php getDataBySymbolN('BK')?></td>
                        <td class="text-success font-weight-medium">
                          <?php getDataBySymbolC('BK')?>
                        </td>
                      </tr>
                      <tr>
                        <td>
                          <p class="mb-n1 font-weight-medium">PM</p>
                          <small class="text-gray">Starbucks Corporation</small>
                        </td>
                        <td class="font-weight-medium"><?php getDataBySymbolN('PM')?></td>
                        <td class="text-success font-weight-medium">
                          <?php getDataBySymbolC('PM')?>
                        </td>
                      </tr>
                      <tr>
                        <td>
                          <p class="mb-n1 font-weight-medium">HD</p>
                          <small class="text-gray">Starbucks Corporation</small>
                        </td>
                        <td class="font-weight-medium"><?php getDataBySymbolN('HD')?></td>
                        <td class="text-success font-weight-medium">
                         <?php getDataBySymbolC('HD')?>
                        </td>
                      </tr>
                      <tr>
                        <td>
                          <p class="mb-n1 font-weight-medium">GE</p>
                          <small class="text-gray">Starbucks Corporation</small>
                        </td>
                        <td class="font-weight-medium"><?php getDataBySymbolN('GE')?></td>
                        <td class="text-success font-weight-medium">
                          <?php getDataBySymbolC('GE')?>
                        </td>
                      </tr>
                    </tbody>
                  </table>
